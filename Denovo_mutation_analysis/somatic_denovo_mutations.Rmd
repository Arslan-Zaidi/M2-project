...
```{r echo=TRUE,warnin=FALSE,message=FALSE,results='hide'}
...
bl.p2<-pnorm(summary(hq.age.c2.bl)$coefficients[2,3],lower.tail = F)
ch.p2<-pnorm(summary(hq.age.c2.ch)$coefficients[2,3],lower.tail = F)
